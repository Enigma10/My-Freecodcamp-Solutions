...
var elPomodoroTime = document.getElementById('pomodoro-time'),	// Pomodoro cycle time display.
    ...
    elPomUp = document.getElementById('pomodoro-time-up'),		// Increate pomodoro time button.
    ...
    elReset = document.getElementById('reset');					// Reset button.

    var myPomodoro = new Pomodoro(25, 5, 'timer', 'message-display');
        // We create a pomodoro using the constructor
    	// above and set the pomodoro cycle to 25 mins,
    	// break to 5 mins and provide the ID for the time
    	// display (in this case, "timer");
